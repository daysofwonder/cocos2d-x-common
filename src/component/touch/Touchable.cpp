...
namespace Dexode
{
    namespace Component
    {
            ...
            , _collector{ nullptr }
        {
            ...
            _listener->onTouchBegan =
                std::bind(&Touchable::onTouchBegan, this, std::placeholders::_1, std::placeholders::_2);
            _listener->onTouchMoved =
                std::bind(&Touchable::onTouchMoved, this, std::placeholders::_1, std::placeholders::_2);
            _listener->onTouchCancelled =
                std::bind(&Touchable::onTouchEnded, this, std::placeholders::_1, std::placeholders::_2);
            _listener->onTouchEnded =
                std::bind(&Touchable::onTouchEnded, this, std::placeholders::_1, std::placeholders::_2);
        }
